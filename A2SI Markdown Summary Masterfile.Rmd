...
**Fixing the question "How Familiar are you with Gave" to show precentages**
...
ggplot(how_familiar, aes(x = Q12_3, y = Percent, fill = Race)) +
  geom_bar(stat = "identity") +
  geom_text(aes(label = paste(format(
    round(Percent, 1), nsmall = 1
  ), "%"), y = Percent),
  position = position_stack(vjust = 0.5)) +
  labs(x = "How Familiar are you with GAVA?", y = "Percentage", fill = "Race")
